...
Aqui, alguns trabalhos realizados em minha tragetória acadêmica
...
O Full Bayesian Significance Test (FBST) é um teste que pode ser realizado para, verificar se uma certa hipótese é
válida ou não, usando apenas a probabilidade posterior e valores observados. Neste EP, verificamos se um certo fabricante de painéis de LED está sendo honesto quanto ao tempo médio de falha de seus produtos, em linguagem R com a biblioteca *nloptr*.

https://github.com/chicodias/numeric_calculus/raw/master/03-ep5.pdf
